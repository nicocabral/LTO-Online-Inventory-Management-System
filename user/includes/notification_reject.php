                ...
                <!-- Page Heading -->
                    ...
                    <div class="col-md-12">
                                        ...
                                        <?php 
											 ...
											 $count_item = mysql_query("select count(status) as sts from tbl_requestitem where req_id='$id' and status='reject'");
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="approved">
                                            <div class="panel-body">
                                                ...
                                                <div id="counter">
                                                    ...
                                                    <span style="font-size: 18px; color: #F00; font-weight:bold;"><?php echo $row['sts'];}?> &nbsp;Rejected</span><?php $count_r=mysql_query("SELECT count(status) as stsa from tbl_requestitem where req_id='$id' and status='approved'");
													while($row=mysql_fetch_array($count_r)){?>
                                                   &emsp; | &emsp;  <a href="notification.php"> <span style="font-size: 18px; color:#209900;  font-weight:bold;"><?php echo $row['stsa'];}?> &nbsp;Approved</span></a>
                                                    </div>
 ...
 <a href="#" data-toggle="tooltip" title="Print?"><span class="glyphicon glyphicon-print"></span></a>
