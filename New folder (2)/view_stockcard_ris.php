  ...
  <div class="container-fluid">
	...
	<div class="row">
		<div class="print-wrapper">
            ...
            <hr>
			<h2 style="text-align:center; font-weight:bold;"> Stock Card</h2>			
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <?php 
		                    ...
		                    $result = mysql_query("SELECT * FROM tbl_requestitem WHERE status='approved' AND itemno=$itemno") or die(mysql_error());
                            $ctr = 1;
		                ...
		                ?>
                            <tr>
                                ...
                                <?php 
                                    $r_balance = $balance - $row['qty'];
                                ?>
                                <td style="text-align:center;"><?php echo $r_balance;?></td>
