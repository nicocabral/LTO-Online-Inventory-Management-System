        ...
        &nbsp;
		  <div class="container-fluid">
		    <div class="hidden-print">
			    ...
			    <button onClick="window.print();" data-toggle="tooltip" title="Print Requisition?"  data-placement="right"><img src="img/icon/printer.ico" width="35px;"></button>
			</div>
			<div class="row">
		            ...
		            <div class="row">
		                <div class="col-md-12">
		                    ...
		                    <div class="col-sm-2">
		                        ...
		                        <span><u>RIS No.:</u> <?php include('includes/dbconn.php');
								$selected = $_POST["selector"];
								foreach ($selected as $result) {
									$sql = mysql_query("SELECT * FROM tbl_requestitem where request_id = $result") or die (mysql_error());
									while($row=mysql_fetch_array($sql)){
							;?> <strong>- &nbsp;<?php echo $row['request_id'];}}?></strong></span>
		                    </div>
		                    <div class="col-sm-2">
		                ...
		                <div class="row">
		                    <div class="issue-wrap">
		                        ...
		                        <div class="col-sm-2">
		                            ...
		                            <em><?php $pos = $_SESSION['position']; echo $pos;?></em></span><br />
