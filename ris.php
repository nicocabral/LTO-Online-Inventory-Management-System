            ...
            <div class="sidebar-collapse">
               <ul class="nav" id="main-menu">
                    ...
                    <ul class="nav nav-second-level">
                            ...
                            <li><a class="active-menu" href="ris.php">RIS</a></li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <!-- Page Heading -->
                      <div class="row">
                        <div class="col-md-12">
                            <h2><img src="img/icon/request.png" width="40px"> List of All Requisition and Issue Slip</h2>
                        <hr><br />
                        <form id="#" action="ris_view_process.php" method="post">
                            <div class="row">
                                    <div class="btn-ris-wrap">
                                        <button style="margin-left:3px;" type="submit" id="move" class="btn btn-success" data-toggle="tooltip" title="View Issue Slip"><span class="glyphicon glyphicon-eye-open"></span></button>
                                        <a href="search_ris.php" data-toggle="tooltip" title="Click to view."><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-search"></span> Search More</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr class="info">
                                            <th  style="text-align:center;" class="hidden-print"><input id="selectall" type="checkbox"></th>
                                    ...
                                    <?php 
                                        ...
                                        $result = mysql_query("SELECT * FROM tbl_requestitem WHERE status='completed' order by stock_no ASC") or die(mysql_error());
                                        $ctr = 1;
                                        while($row = mysql_fetch_array($result)){
                                    ?>
                                        <tr>
                                            <td class="text-center hidden-print"><center><input type="checkbox" name="selector[]" class="select" value="<?php echo $row['request_id'];?>"></center></td>
