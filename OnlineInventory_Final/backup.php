                            ...
                            <li> <a href="about_settings.php">About Settings</a></li>
                              <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li><a class="active-menu" href="backup.php">Backup Database</a></li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <!-- Page Heading -->
                      <div class="row">
                        <div class="col-md-12">
                            <h2><img src="img/icon/backup.png" width="60px"> Backup Database</h2>
                        <hr>
                        <div id="logMsg"></div>
                             <form name="import" id="frmBackup" enctype="multipart/form-data">
                                <label>Click below to Backup Database: 
                                <p>
                                    <input type="submit" class="btn btn-primary" name="backup" value="Backup">
                                </p>
                            </form>
                        </div>
                      </div>
