...
<br><p></p>
  ...
  <div class="container-fluid">
    <div class="hidden-print">
        <div class="row">
            <div class="col-md-3">
        	    <span><a class="btn btn-danger" data-toggle="tooltip" title="Back" href="view_inventory.php"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Back</a></span>
        	    <span><button onClick="window.print();" class="btn btn-success"><span class="glyphicon glyphicon-print"></span> Print</button></span>
    	    </div>
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                ...
                <form action="inventory.php" method="POST">
                    ...
                    <div id="btn-all" class="form-group input-group">
                        ...
                        <button class="btn btn-primary btn-sm" type="submit"><i class="fa fa-search"></i> Seach All</button>
                    </div>
                 </form>
                 <!-- end -->
