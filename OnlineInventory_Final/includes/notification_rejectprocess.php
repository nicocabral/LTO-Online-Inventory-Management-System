        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
               <ul class="nav" id="main-menu">
                    ...
                    <a href="notification.php"><img src="img/icon/purchaseorder.png" width="40px">&nbsp; Notification <span class="btn btn-info">&nbsp;<?php echo $row['count'];?></span></a></li>
                    <?php }?>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <!-- Page Heading -->
					...
					<div class="row">
                    <div class="col-md-12">
                    <p>Confirm to reject this item(s) request</p>
                     <?php 
                    ...
                    ?>
                        <form  name="frmReject" action="reject_process.php" method="post" class="form-horizontal">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name" class="col-sm-3 control-label">Item No.</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="<?php echo $req_id; ?>" id="itemno" name="itemno" required readonly />
                                    </div>
                                </div> 
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="<?php echo $row['qty']; ?>" id="name" name="rqty"  required readonly>
                                    </div>
                                </div> 
                                <div class="form-group">
                               ...
                               <br>
                                <div class="pull-right" style="padding-right:50px;">
                                    <a href="notification.php" class="btn btn-success"><span class="glyphicon glyphicon-arrow-left"></span> Back</a>
                                    <button type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-thumbs-down"></span> Reject Request</button> 
                                </div>
                            </div>
                            </form>
                            <?php }?>
