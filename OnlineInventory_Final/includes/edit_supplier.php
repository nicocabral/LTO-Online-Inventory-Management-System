					...
					<div class="row">
                     <div class="wrap-btn">
                      ...
                      <h3>Edit supplier Info</h3>
                             ...
                             <form name="frm_editSupplier" action="edit_supplier_process.php" method="post" class="form-horizontal">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="<?php echo $row['suppname'];?>" id="suppname" name="suppname">
                                    </div></div>
