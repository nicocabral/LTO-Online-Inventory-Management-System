        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <!-- Page Heading -->
                    ...
                    <div class="wrap-btn">
                        <div class="col-md-6">
                           <a href="print_supplier.php" data-toggle="tooltip" title="Print"><button class="btn btn-default"><span class="glyphicon glyphicon-print"></span></button></a>
                                ...
                                <br>
                                    <form class="form-horizontal" method="POST" action="add_supplier_process.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="name" name="status" onKeyPress="return isNotAlphanumeric(event)" required>
                                            </div>
                                        </div>
				  ...
				  ?>
                                   <option value="<?php echo $row['suppno']?>"><?php echo $row['suppname'];}?></option>
                                    </select>
