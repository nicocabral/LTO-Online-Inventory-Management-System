        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <!-- Page Heading -->
                      <div class="row">
                        <div class="col-md-12">
                            <h2><img src="img/icon_png/a_inventory_256.png" width="50px"> Item Stock Card</h2>
                        <hr><br />
                                ...
                                <table class="table table-striped table-bordered">
                                    <thead>
                                        <tr class="info">
                                            ...
                                            <th style="text-align:center; width:auto;">Supply Quantity</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php 
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-cente"><center>
                                                <a href="view_stockcard_ris.php?itemno=<?php echo $row['itemno'];?>&&stockno=<?php echo $row['stock_no'];?>" data-toggle="tooltip" title="View Item StockCard"><img src="img/icons/print_preview.ico" width="20px"></a>
