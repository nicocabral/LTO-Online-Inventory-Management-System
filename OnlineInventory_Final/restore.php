                            ...
                            <li> <a href="about_settings.php">About Settings</a></li>
                              <li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li><a class="active-menu" href="restore.php">Restore Database</a></li>
                                </ul>
                            </li> 
                        </ul>
                    </li> 
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <!-- Page Heading -->
                      <div class="row">
                        <div class="col-md-12">
                            <h2><img src="img/icon/restore.png" width="60px"> Restore Database</h2>
                        <hr>
                             <form name="import" action="restore_process.php" method="POST" enctype="multipart/form-data">
                                ...
                                <p>
                                    <input type="submit" id="btn-wait" class="btn btn-primary" name="restore" value="Restore">
                                </p>
                            </form>
                            <div id="wait"><em><strong>Uploading database. Please wait...</strong></em></div>
                        </div>
                      </div>
