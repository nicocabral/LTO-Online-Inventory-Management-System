        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="container-fluid">
                    ...
                    ?>
                    <div class="btn btn-info"><strong>Item(s)</strong>&nbsp;<span class="badge pull-right"><?php echo $ctr_row['counter']; ?></span></div>
                    <?php } ?>
                    </div>
                    <div class="row">  
                    <div class="col-md-12">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="font-family:verdana;">
                                              <center>
                                               <?php /*?> <button <?php echo $dis;?> class="btn btn-success btn-sm"><a href="request_form.php?id=<?php echo $row['itemno'];?>"><span id="edit_href">Request Item</a></span></button><?php */?>
                                                <button <?php echo $dis;?> class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal"> <span id="edit_href">Request Item</span></button>
                                                <!-- Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4 class="modal-title alert alert-danger" id="myModalLabel"><form ><label>Warning! You have to login to request this item</label></form></h4>
      </div>
