        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
               <ul class="nav" id="main-menu">
                    ...
                    <a class="active-menu" href="#"><img src="img/icons/web_help2.ico" width="40px">&nbsp; Notification <span class="btn btn-info" data-toggle="tooltip" title="Hey you have Notification">&nbsp;<?php echo $row['count'];}?></span>
