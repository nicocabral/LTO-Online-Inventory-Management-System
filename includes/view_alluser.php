...
<div class="page-header">
    	<h2>List of all system user. | 
         <a href="user_settings.php" data-toggle="tooltip" title="Back to admin settings" class="btn btn-default">Back to admin settings</a>
        
        </h2>
<?php
	
	$stmt = $DB_con->prepare('SELECT id, name, address, contact, position, office, username, password, userpic, user_type FROM user where user_type="user" ORDER BY id ASC');
	$stmt->execute();
   ...
   <div class="row">
   	<div class="col-xs-12">
    <center>
   		<p class="page-header"><?php echo $name." "."&nbsp;/&nbsp;"." ".$user_type; ?><br />
