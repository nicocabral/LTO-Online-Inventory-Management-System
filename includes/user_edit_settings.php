<?php 
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		$uname =mysql_real_escape_string( $_POST['username']);// user name
		...
		if($imgFile)
		{
			...
			$upic = rand(100000,999999).".".$imgExt;
		...
		else
		{
			...
			$upic = $edit_row['userpic']; // old image from database
		}	
